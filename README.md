...
│   │   ├── banco-articulos/                     → 5 artículos (1+ por línea DTI)
│   │   └── plantillas/                          → análisis metodológico · potencia_plantilla.ipynb
...
└── matriz-documental.md                        → índice maestro: artefacto ↔ ciclo ↔ semana
```
