...
1. **Instala Anaconda** (versión más reciente). Incluye los paquetes base del entorno: pandas, scipy, statsmodels, scikit-learn, matplotlib, seaborn. `pingouin` se instala aparte con `pip install pingouin`.
...
4. **Alternativa sin instalación local:** abre el notebook en [Google Colab](https://colab.research.google.com/) y ejecútalo en la nube (`!pip install pingouin` y reinicia el runtime).
...
| `instalacion-anaconda.md` | Guía paso a paso de instalación de Anaconda *(por agregar)*. |
| `guia-colab.md` | Uso de Google Colab como alternativa *(por agregar)*. |
